...
export function Header() {
  ...
  // Dark glassmorphic marketing nav for signed-out visitors. The authenticated
  // app keeps its existing light header below -- this doesn't touch that.
  if (!isLoading && !user) {
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/login"
                className="hidden sm:inline-flex px-4 py-2 text-sm font-semibold text-white border border-white/20 rounded-lg hover:bg-white/5 hover:border-white/40 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400"
              >
                Log In
              </Link>
              <Link
                href="/register"
                className="hidden sm:inline-flex px-4 py-2 text-sm font-semibold text-white rounded-lg bg-gradient-to-r from-primary-400 to-primary-700 shadow-[0_4px_24px_rgba(56,189,248,0.3)] hover:brightness-110 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400"
              >
                Get Started
              </Link>
