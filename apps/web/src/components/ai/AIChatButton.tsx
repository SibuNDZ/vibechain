  ...
  return (
    <>
      ...
      >
        ...
        {/* Tooltip */}
        <span className="absolute right-full mr-3 px-3 py-1.5 bg-[#0A0A0A] border border-white/10 text-white/80 text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-sm">
          Ask AI
        </span>
      </button>
