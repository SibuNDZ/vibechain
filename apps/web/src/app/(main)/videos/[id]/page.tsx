      ...
      <main className="min-h-screen bg-[#050505] py-8">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center py-16">
            ...
            <p className="text-white/50">{error || "This video doesn't exist or has been removed."}</p>
          </div>
        </div>
      </main>
    );
          ...
          <div className="lg:col-span-1">
            <div className="vc-card p-6 sticky top-8">
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary-400 to-primary-700 flex items-center justify-center overflow-hidden">
