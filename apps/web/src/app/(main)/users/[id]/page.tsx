      ...
      <div className="min-h-screen bg-[#050505] py-8">
        <div className="max-w-6xl mx-auto px-4">
          <div className="animate-pulse">
            <div className="h-32 w-32 rounded-full bg-white/10 mx-auto mb-4" />
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div className="relative">
              {user.avatarUrl ? (
                ...
                <div className="w-32 h-32 rounded-full bg-gradient-to-br from-primary-400 to-primary-700 flex items-center justify-center text-white text-4xl font-bold border-4 border-primary-400">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              {/* Meta info */}
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mb-4 text-sm text-white/50">
                {user.walletAddress && (
              ...
              <div className="flex items-center justify-center md:justify-start gap-6 mb-4">
                ...
                <div className="text-center px-3 py-2">
                  ...
                  <span className="text-white/50 text-sm">Videos</span>
                </div>
              </div>
              ...
              {!isOwnProfile && currentUser && (
                <div className="flex items-center justify-center md:justify-start gap-3">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 px-6 py-2 border border-white/10 text-white/80 rounded-lg hover:bg-white/5 transition-colors"
                  >
